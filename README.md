...
A fast, seedable, pseudo-random number generator for JavaScript.

## Why is this useful? 
This is useful in situation the you need to generate random numbers or a list of random numbers, but you want to generate the same ones every time. 
